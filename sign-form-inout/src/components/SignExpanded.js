                ...
                {({flexVal}) =>
                    ...
                    >
                        ...
                        <Motion style={{
                            ...
                            {({opacity, y}) =>
                                <form action="" className='logForm' style={{
                                ...
                                >
                                    ...
                                    <a href="url"
                                       className='forgotPass'>{this.props.type === 'signIn' ? 'Forgot password?' : ''}</a>
                                </form>
                            }
                        </Motion>
                    </div>
